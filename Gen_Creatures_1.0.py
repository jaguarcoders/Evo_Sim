...
def genName():
    name = ""
    frequentCons = ["n","l","r","y","s"]
    commonCons = ["h","m","t","d","c","j","b","k"]
    unusualCons = ["v","g","p","z","w","x","f","q"]
    repeatCons = ["m","n","p","d"]
    hCons = ["c","t","s","p"]
    lCons = ["c","b","f","g","p","s"]
    rCons = ["b","c","f","g","p","t","w"]
    ...
    if random.randint(1,5) == 1:
        ...
        if random.randint(1,4) == 1:
            if random.randint(1,3) == 1:
                letter = random.choice(unusualCons)
            else:
                letter = random.choice(commonCons)
        else:
            letter = random.choice(frequentCons)
    name += letter.upper()
            ...
            if name[-1] not in hCons:
                if name[-1] not in lCons:
                    if name[-1] not in rCons:
                        if name[-1] not in kCons:
                            if name[-1] not in repeatCons:
...
def collectLimbValues():
    try:
        minLimbStr = int(raw_input("Select a number from 1 to 100 for the minimum limb strength. "))
        maxLimbStr = int(raw_input("Select a number from " + str(minLimbStr) + " to 100 for the maximum limb strength. "))
        ...
        minLimb = int(raw_input("Select a number from 1 to 8 for the minimum number of limbs. "))
        maxLimb = int(raw_input("Select a number from " + str(minLimb) + " to 8 for the maximum number of limbs. "))
        if maxLimb < minLimb:
            setter = minLimb
            minLimb = maxLimb
            maxLimb = setter
...
def collectAppendageValues():
    try:
        minAppendageStr = int(raw_input("Select a number from 1 to 100 for the minimum appendage strength. "))
        maxAppendageStr = int(raw_input("Select a number from " + str(minAppendageStr) + " to 100 for the maximum appendage strength. "))
        ...
        minAppendage = int(raw_input("Select a number from 1 to 3 for the minimum number of appendages. "))
        maxAppendage = int(raw_input("Select a number from " + str(minAppendage) + " to 3 for the maximum number of appendages. "))
...
def collectPhalangeValues():
    try:
        minPhalangeStr = int(raw_input("Select a number from 1 to 100 for the minimum phalange strength."))
        maxPhalangeStr = int(raw_input("Select a number from " + str(minPhalangeStr) + " to 100 for the maximum phalange strength."))
        ...
        minPhalange = int(raw_input("Select a number from 1 to 5 for the minimum number of phalanges."))
        maxPhalange = int(raw_input("Select a number from " + str(minPhalange) + " to 5 for the maximum number of phalanges."))
...
class Creature():
    ...
    def create(self):
        ...
        screenHeight = GetSystemMetrics(1)-50
